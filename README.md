...
- Configurable Node.js version with specific version support (e.g. 24, 24.14, 22.3.1)
...
| `NODE_VERSION` | 24 | Node.js version (e.g. 24, 24.14, 22.3.1) |
...
- Node.js (configurable version, default v24), yarn
- redis-server
